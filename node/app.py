...
def runApp():
    ...
    print("\n\n\DUMP JSON DONE\n\n\n")
    print(f"os.path.realpath(fpath) = {os.path.realpath(fpath)}")
    ...
    print("\n\n\CHMOD DONE\n\n\n")
    pat = "./app.py"
    print(f"os.path.realpath(pat) = {os.path.realpath(pat)}")
    print(f"os.getcwd() = {os.getcwd()}")
