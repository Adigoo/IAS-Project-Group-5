...
cd ui_manager
gnome-terminal --title="ui_manager" -x bash -c "python app.py; exec bash"


cd ../model_manager
gnome-terminal --title="model_manager" -x bash -c "python3 model_service.py; exec bash"
...
cd ../scheduler
gnome-terminal --title="scheduler" -x bash -c "python3 scheduler.py; exec bash"

cd ../deployer
gnome-terminal --title="deployer" -x bash -c "python3 deployer.py; exec bash"
